...
<div class='container'>
    ...
    <a class="btn btn-primary mb-3" href="<%=request.getContextPath()%>/DepartmentServlet?action=agregar">Crear
        Department</a>
    <table class="table">
        <tr>
            <th>Dep ID</th>
        ...
        <tr>
            ...
            <td><%=dep.getManager().getFirstName()+" "+dep.getManager().getLastName()%>
            </td>
            <td><%=dep.getLocation().getStreetAddress()%>
            </td>
            <td>
